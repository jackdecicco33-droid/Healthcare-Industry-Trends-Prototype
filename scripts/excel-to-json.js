...
function writeFrontendDataModule(resources, terminology) {
  const moduleSource = [
    '// Generated by scripts/excel-to-json.js from the Excel workbook.',
    '// Active frontend source for Resource Library and Learn the Language.',
...
function main() {
  ...
  writeFrontendDataModule(resources, terminology);
